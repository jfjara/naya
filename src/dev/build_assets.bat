...
..\..\src\utils\buildlevels_MK1.exe ..\bin\level0.bin mapfile=..\map\mapa0.MAP nsprites=24 map_w=3 map_h=10 tilesfile=..\gfx\work0.png behsfile=..\gfx\behs0.txt defaultink=7 spritesfile=..\gfx\sprites0.png enemsfile=..\enems\enems0.ene scr_ini=0 ini_x=2 ini_y=8 enems_life=2 > nul
