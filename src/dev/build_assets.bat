...
..\..\src\utils\buildlevels_MK1.exe ..\bin\level1.bin mapfile=..\map\mapa1.MAP nsprites=24 map_w=3 map_h=10 tilesfile=..\gfx\work1.png behsfile=..\gfx\behs1.txt defaultink=1 spritesfile=..\gfx\sprites1.png enemsfile=..\enems\enems1.ene scr_ini=27 ini_x=2 ini_y=8 enems_life=2 > nul
